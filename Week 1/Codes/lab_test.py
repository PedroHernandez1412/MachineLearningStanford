...
filter_car = dataframe[dataframe['Car_Name'].str.contains('brio', na=False)]
...
def gradient_descent(x, y, w_in, b_in, alpha, num_iters, cost_function, gradient_function): 
    ...
    return w, b, J #return w and J,w history for graphing
...
w_final, b_final, J = gradient_descent(x_train ,y_train, w_init, b_init, tmp_alpha, 
